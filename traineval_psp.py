...
def TrainEval(budget=100,benchmarks=["nas101","nas201","nas301"],repeat=5):
    ...
    eval_ns101_cell_pths=SamplingBatches("exps_setting/eval_setting_ns101.json",nas101_cell_dir,10000,1,False)[0]
    eval_ns201_cell_pths=SamplingBatches("exps_setting/eval_setting_ns201.json",nas201_cell_dir,10000,1,False)[0]
    eval_ns301_cell_pths=SamplingBatches("exps_setting/eval_setting_ns301.json",nas301_cell_dir,10000,1,False)[0]
    ...
    for i,ns301_cell_pths in enumerate(ns301_cell_pths_list):
        ...
        data_gen=DataGenerator(train_cell_pths,acc_anchors)
        dg=data_gen.Gen()
...
# TrainEval(5,["nas101"],repeat)
# TrainEval(5,["nas201"],repeat)
# TrainEval(5,["nas301"],repeat)

# TrainEval(50,["nas101"],repeat)
# TrainEval(50,["nas201"],repeat)
# TrainEval(50,["nas301"],repeat)

# TrainEval(100,["nas101"],repeat)
# TrainEval(100,["nas201"],repeat)
TrainEval(100,["nas301"],repeat)
